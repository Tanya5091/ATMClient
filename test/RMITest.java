...
public class RMITest {
    ...
    @Test
    public void changePinTest() throws RemoteException {
        connect();
        User user;
        try {
...
//            Assert.assertFalse(rmiServer.changePIN("fsdgshdf", 32525, 343, 34));
            ...
            if (cardHolderName != null&&cardHolderName1!=null) {
                ...
                Assert.assertTrue(round(bal1BefTrans-bal1AfTrans)==100);
                Assert.assertTrue(round(bal2AfTrans-bal2BefTrans)==100);
            }
        } catch (RemoteException  e) {
            e.printStackTrace();
        }
